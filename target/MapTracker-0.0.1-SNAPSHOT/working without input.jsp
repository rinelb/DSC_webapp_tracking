...
<!-- Device <input id="inputTopic" value="NRF123456789"></input>  <button onclick="start_topic()">Start</button><br> -->
<p id="lat"></p>
<p id="long"></p></center>
<div id="map"></div>
</body>
...
var map = L.map('map').setView([-25.7566505, +28.2783488], 20);
...
// 			  console.log("onMessageArrived:"+message.payloadString);
			  ...
			  protobuf.load("js/kurapayload.proto", function(err1, root) {
			    ...
			    firstpolyline.addLatLng([object.metric[0].doubleValue, object.metric[1].doubleValue]);
